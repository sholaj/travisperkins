...
variables needed for Boto have already been set:
    #export AWS_ACCESS_KEY_ID='AKIAJLQQ3YHMHT7DN4SQ'
    #export AWS_SECRET_ACCESS_KEY='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'
    export AWS_ACCESS_KEY_ID = 'AKIAJXNSWZYR77BEXJDA'
    export AWS_SECRET_ACCESS_KEY = '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'

This script also assumes there is an ec2.ini file alongside it.  To specify a
different path to ec2.ini, define the EC2_INI_PATH environment variable:

    export EC2_INI_PATH=/Users/shola/Documents/mydevops/vagrant-ansible/ansible/inventory/ec2.ini
...
the AWS_PROFILE variable:
    ...
    AWS_PROFILE=yubl ansible-playbook -i ec2.py playbook.yml
